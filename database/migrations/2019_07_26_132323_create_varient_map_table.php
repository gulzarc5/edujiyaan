...
class CreateVarientMapTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('varient_map', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('varient_id',255);
    ...
    {
        Schema::dropIfExists('varient_map');
    }
}
