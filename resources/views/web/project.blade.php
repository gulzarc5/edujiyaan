							    ...
							    <div class="row">
							        <div class="filterDiv">
                                        ...
                                        <div class="product-wrapper mb-40 " style="">
                                        	<h4><a href="single_project.php?project_no=38">Chinmoyee Project 2</a></h4>
                                        	<div class="col-md-6">
                                            <div class="product-details">                                                
                                                <h4><a href="single_project.php?project_no=38">Project ID: CHIN124</a></h4>
                                                <h4><a href="single_project.php?project_no=38">Total pages: 123</a></h4>
                                                <h4><a href="single_project.php?project_no=38">Cost: Rs. 2001</a></h4>
                                                </div>
                                            	<div class="">
                                            ...
                                            <div class="col-md-6">
	                                            <div class="">
	                                                <h5>Specialisation: <span>Retail</span></h5>
	                                            	<h4>Package Includes:</h4><p>Preview/<span>Documentation</span>/<span>PPT</span>/</p>
	                                            </div>
                                            </div>
